...
const emit = defineEmits(['update:showing-navigation-dropdown']);
</script>
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <Link :href="route('home')" class="flex items-center">
                        ...
                        <span class="ms-2 font-bold text-lg">BizKit</span>
                    </Link>
                </div>
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button
                    ...
                    @click="emit('update:showing-navigation-dropdown', !showingNavigationDropdown)"
                    >
                    <svg
                        class="size-6"
                        stroke="currentColor"
